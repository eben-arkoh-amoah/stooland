...
" size={20}/>}
            ...
            <label htmlFor="forgotPasswordPassword" style={{fontSize: 13, color: "#344054", fontWeight: "500"}}>New Password</label>
            <input type={shouldShowPassword ? "text": "password"} id="forgotPasswordPassword" placeholder="Enter your new password" style={{ borderWidth: 1, borderColor: "#D0D5DD", boxShadow: "2px 2px 0px #1018280D", borderRadius: 8, padding: 4, paddingLeft: 12, fontSize: 14, fontWeight: "400", color:"#667085", width: "100%", outline: "none"}} />
                        </fieldset>
                          <fieldset style={{ display: "flex", justifyContent: "center", alignItems: "flex-start", flexDirection: "column", gap: 5, width: "75%", margin: "auto", position: "relative" }}>
...
" size={20}/>}
            ...
            <label htmlFor="resetPasswordConfirm" style={{fontSize: 13, color: "#344054", fontWeight: "500"}}>Confirm Password</label>
                          <input type={shouldShowConfirmPassword ? "text" : "password"} id="resetPasswordConfirm" placeholder="Confirm your password" style={{ borderWidth: 1, borderColor: "#D0D5DD", boxShadow: "2px 2px 0px #1018280D", borderRadius: 8, padding: 4, paddingLeft: 12, fontSize: 14, fontWeight: "400", color:"#667085", width: "100%", outline: "none"}} />
          </fieldset>                    
            </div>
